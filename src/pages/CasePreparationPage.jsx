...
import { 
  Briefcase, FolderOpen, ClipboardList, CheckCircle, ArrowRight, Shield, 
  Archive, FileStack, ChevronDown, ChevronUp 
} from 'lucide-react';
...
const CasePreparationPage = () => {
  ...
  const faqs = [
    {
      q: "Are your trial bundles e-bundle compliant for UK courts?",
      a: "Yes. We prepare fully searchable, hyperlinked, and indexed PDF e-bundles that strictly follow the General Guidance on PDF Bundles issued by the Senior Presiding Judge."
    },
    {
      q: "Can you handle large-scale document pagination?",
      a: "Absolutely. We manage pagination for thousands of pages, ensuring every page is clearly marked and cross-referenced within the core and supplemental bundles."
    },
    {
      q: "Do you offer physical bundle preparation and delivery?",
      a: "While we primarily focus on digital preparation, we can coordinate with professional printing services to ensure physical bundles are delivered to your office or the court on time."
    },
    {
      q: "How do you handle late-arriving evidence?",
      a: "We have a streamlined 'Insert Protocol' that allows us to integrate late evidence into existing bundle structures without breaking the pagination sequence, using sub-pages (e.g., 10a, 10b)."
    },
    {
      q: "What software do you use for bundle compilation?",
      a: "We utilize industry-leading tools like Caselines, Bundledocs, and Adobe Acrobat Pro with legal-specific plugins to ensure technological reliability."
    }
  ];
    ...
    <div className="min-h-screen bg-[#2A454E] flex flex-col overflow-hidden">
      <main className="flex-grow pt-32 lg:pt-48 pb-24">
        ...
        <header className="hidden">
          <h1>Court-Ready Case Preparation & E-Bundling UK - H&S Co.</h1>
          <p>Expert preparation of trial bundles, hyperlinked e-bundles, and document indexing for UK legal proceedings.</p>
        </header>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className={`transition-all duration-1000 transform ${visibleSections.hero ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-[50vw]'}`}>
              <div className="flex items-center gap-4 mb-6">
                ...
                <span className="text-[#A07A41] uppercase tracking-[0.3em] text-xs font-bold font-sans underline decoration-[#A07A41]/30">CASE LOGISTICS</span>
              </div>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-white leading-tight mb-8">
                Court-Ready <br />
                <span className="italic font-light text-[#A07A41]">Case Logistics.</span>
              </h1>
              <p className="text-gray-300 text-lg md:text-xl font-sans font-light leading-relaxed max-w-2xl mb-10">
                A disorganized bundle can lose a case. We ensure your documentation is flawless, indexed, and fully compliant with the latest Judicial Practice Directions for both physical and digital courtrooms.
              </p>
              <div className="flex flex-wrap gap-6">
                <div className="flex items-center gap-3 text-white/80 text-sm font-medium tracking-wide border border-white/10 px-5 py-3 rounded-full bg-white/5">
                  <Archive className="h-4 w-4 text-[#A07A41]" />
                  Hyperlinked E-Bundles
                </div>
                <div className="flex items-center gap-3 text-white/80 text-sm font-medium tracking-wide border border-white/10 px-5 py-3 rounded-full bg-white/5">
              ...
              <div className="relative aspect-square max-w-md ml-auto overflow-hidden rounded-2xl border border-white/10 shadow-big group">
                ...
                <div className="absolute bottom-8 left-8 z-20">
                  <div className="p-6 bg-[#A07A41] text-white rounded-lg shadow-xl translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                    <p className="text-xs uppercase tracking-widest font-bold mb-2">Efficiency Boost</p>
                    <p className="text-3xl font-serif font-bold">50% Faster</p>
                    <p className="text-sm opacity-80 italic">Bundle Compilation Time</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        >
          <div className="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`max-w-3xl mb-20 transition-all duration-1000 transform ${visibleSections.capabilities ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
              <h2 className="text-3xl md:text-5xl font-serif font-bold text-white mb-6">Strategic Case <span className="text-[#A07A41]">Support.</span></h2>
              <p className="text-gray-400 text-lg font-light leading-relaxed">
                We handle the administrative complexities of litigation, allowing you to focus on the legal arguments and client relations.
              </p>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { title: 'E-Bundling', desc: 'Creation of hyperlinked, searchable PDF bundles according to High Court standards.', icon: FileStack },
                { title: 'Pagination & Indexing', desc: 'Systematic chronological ordering and page numbering for massive document sets.', icon: ClipboardList },
                { title: 'Disclosure Analysis', desc: 'Triaging and cataloging documents for the disclosure phase of civil litigation.', icon: FolderOpen },
                { title: 'Court Filing', desc: 'Coordination of electronic filing (E-Filing) and distribution to opposing counsel.', icon: Briefcase }
              ].map((item, idx) => (
                <div 
                  key={idx} 
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-4 pt-12">
                    <div className="aspect-[4/5] bg-white/5 rounded-xl border border-white/10 overflow-hidden">
                      <img src="https://images.unsplash.com/photo-1544027993-37dbfe43562a?auto=format&fit=crop&q=80" className="w-full h-full object-cover grayscale opacity-50 transition-opacity hover:opacity-100 duration-700" alt="Prep 1" />
                    </div>
                    <div className="aspect-square bg-white/5 rounded-xl border border-white/10 overflow-hidden">
                      <img src="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&q=80" className="w-full h-full object-cover grayscale opacity-50" alt="Prep 2" />
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div className="aspect-square bg-white/5 rounded-xl border border-white/10 overflow-hidden">
                      <img src="https://images.unsplash.com/photo-1423592707957-3b212afa6733?auto=format&fit=crop&q=80" className="w-full h-full object-cover grayscale opacity-50" alt="Prep 3" />
                    </div>
                    <div className="aspect-[4/5] bg-white/5 rounded-xl border border-white/10 overflow-hidden">
                      <img src="https://images.unsplash.com/photo-1505664194779-8beaceb93744?auto=format&fit=crop&q=80" className="w-full h-full object-cover grayscale opacity-50" alt="Prep 4" />
                    </div>
                  </div>
                </div>
              ...
              <div className={`order-1 lg:order-2 transition-all duration-1000 transform ${visibleSections.methodology ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-[30vw]'}`}>
                <h2 className="text-4xl md:text-5xl font-serif font-bold text-white mb-10 leading-tight">
                  Our Bundle <br />
                  <span className="italic font-light text-[#A07A41]">Execution Plan.</span>
                </h2>
                <div className="space-y-10">
                  {[
                    { step: '01', title: 'Deep Discovery', text: 'Cataloging every piece of evidence, email, and application in your case file for systematic sorting.' },
                    { step: '02', title: 'Pagination & Indexing', text: 'Applying uniform, clear page numbering and building an exhaustive index for swift courtroom navigation.' },
                    { step: '03', title: 'Technical Compilation', text: 'Compiling the final PDF bundle with internal hyperlinks for all sections and referenced exhibits.' },
                    { step: '04', title: 'Judicial Compliance', text: 'Final verification against CPR and local court guidelines before secure digital delivery.' }
                  ].map((item, idx) => (
        ...
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`text-center mb-16 transition-all duration-1000 transform ${visibleSections.faqs ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
              ...
              <p className="text-gray-400 font-light">Navigating the complexities of bundle preparation and filing.</p>
            </div>
          ...
          <div className={`max-w-6xl mx-auto bg-[#1B2D33] rounded-3xl p-12 lg:p-20 border border-[#A07A41]/20 relative overflow-hidden text-center transition-all duration-1000 transform ${visibleSections.cta ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-20 scale-95'}`}>
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-serif font-bold text-white mb-8">
                Flawless Bundles <br />
                <span className="italic font-light text-[#A07A41]">Guaranteed.</span>
              </h2>
              <p className="text-gray-400 text-lg md:text-xl font-light mb-12 max-w-2xl mx-auto">
                Delegate the document grind. Win cases with bundles that judges love to use.
              </p>
