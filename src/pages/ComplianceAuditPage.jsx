...
import { 
  ShieldCheck, FileCheck, ClipboardCheck, CheckCircle, ArrowRight, Shield, 
  Search, Gavel, ChevronDown, ChevronUp, AlertCircle 
} from 'lucide-react';
...
const ComplianceAuditPage = () => {
  ...
  const faqs = [
    {
      q: "How do you ensure SRA compliance for outsourced tasks?",
      a: "Our entire workflow is mapped to the SRA Code of Conduct. We maintain rigorous standards for supervision, confidentiality, and technical accuracy, ensuring that all work products integrate seamlessly with your firm's regulatory obligations."
    },
    {
      q: "Do you offer Anti-Money Laundering (AML) check support?",
      a: "Yes. We assist firms in the administrative gathering and verification of KYC/AML documentation, ensuring that all client due diligence (CDD) satisfies current UK reporting standards."
    },
    {
      q: "Can you perform conflict of interest searches?",
      a: "Absolutely. We can integrate with your firm's case management system to perform systematic conflict searches as part of the initial file setup process."
    },
    {
      q: "How are data breach risks mitigated during the audit process?",
      a: "We utilize encrypted virtual data rooms (VDRs) and multi-factor authentication (MFA) for all document handling. Our internal systems are regularly audited for compliance with UK Data Protection Act 2018 standards."
    },
    {
      q: "Do you provide a final compliance certificate for the audit?",
      a: "Every audit project is accompanied by a 'Compliance Audit Summary' (CAS) report, detailing the checks performed, findings, and any remedial actions taken to ensure file integrity."
    }
  ];
    ...
    <div className="min-h-screen bg-[#2A454E] flex flex-col overflow-hidden">
      <main className="flex-grow pt-32 lg:pt-48 pb-24">
        ...
        <header className="hidden">
          <h1>SRA Compliance & Legal Audit Services UK - H&S Co.</h1>
          <p>Expert legal compliance support, file auditing, AML checks, and SRA standard oversight for UK law firms and legal practices.</p>
        </header>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className={`transition-all duration-1000 transform ${visibleSections.hero ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-[50vw]'}`}>
              <div className="flex items-center gap-4 mb-6">
                ...
                <span className="text-[#A07A41] uppercase tracking-[0.3em] text-xs font-bold font-sans underline decoration-[#A07A41]/30">REGULATORY STANDARDS</span>
              </div>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-white leading-tight mb-8">
                Iron-Clad <br />
                <span className="italic font-light text-[#A07A41]">Legal Compliance.</span>
              </h1>
              <p className="text-gray-300 text-lg md:text-xl font-sans font-light leading-relaxed max-w-2xl mb-10">
                In a regulated environment, there is no room for error. We provide rigorous auditing and compliance support that aligns with SRA guidelines, ensuring your firm's reputation and regulatory standing remain beyond reproach.
              </p>
              <div className="flex flex-wrap gap-6">
                <div className="flex items-center gap-3 text-white/80 text-sm font-medium tracking-wide border border-white/10 px-5 py-3 rounded-full bg-white/5">
                  <ShieldCheck className="h-4 w-4 text-[#A07A41]" />
                  SRA Standards Oversight
                </div>
                <div className="flex items-center gap-3 text-white/80 text-sm font-medium tracking-wide border border-white/10 px-5 py-3 rounded-full bg-white/5">
                  <AlertCircle className="h-4 w-4 text-[#A07A41]" />
                  Internal Risk Audit
                </div>
              </div>
            </div>
              ...
              <div className="relative aspect-square max-w-md ml-auto overflow-hidden rounded-2xl border border-white/10 shadow-big group">
                ...
                <div className="absolute bottom-8 left-8 z-20">
                  <div className="p-6 bg-[#A07A41] text-white rounded-lg shadow-xl translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                    <p className="text-xs uppercase tracking-widest font-bold mb-2">Audit Accuracy</p>
                    <p className="text-3xl font-serif font-bold">Zero-Defect</p>
                    <p className="text-sm opacity-80 italic">Compliance Methodology</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        >
          <div className="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`max-w-3xl mb-20 transition-all duration-1000 transform ${visibleSections.capabilities ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
              <h2 className="text-3xl md:text-5xl font-serif font-bold text-white mb-6">Rigorous Audit <span className="text-[#A07A41]">Architecture.</span></h2>
              <p className="text-gray-400 text-lg font-light leading-relaxed">
                We transform compliance from a burden into a competitive advantage, ensuring every file in your system is technically sound and regulatorily compliant.
              </p>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { title: 'SRA Supervision', desc: 'Detailed file reviews to ensure adherence to SRA supervision and quality standards.', icon: Gavel },
                { title: 'AML Support', desc: 'Managed document collection and verification for Anti-Money Laundering compliance.', icon: Search },
                { title: 'Data Audits', desc: 'Systematic checks for GDPR and data protection alignment across all case files.', icon: ClipboardCheck },
                { title: 'Conflict Searches', desc: 'High-precision conflict-of-interest analysis during the file intake phase.', icon: FileCheck }
              ].map((item, idx) => (
                <div 
                  key={idx} 
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-4 pt-12">
                    <div className="aspect-[4/5] bg-white/5 rounded-xl border border-white/10 overflow-hidden">
                      <img src="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&q=80" className="w-full h-full object-cover grayscale opacity-50 transition-opacity hover:opacity-100 duration-700" alt="Audit 1" />
                    </div>
                    <div className="aspect-square bg-white/5 rounded-xl border border-white/10 overflow-hidden">
                      <img src="https://images.unsplash.com/photo-1544027993-37dbfe43562a?auto=format&fit=crop&q=80" className="w-full h-full object-cover grayscale opacity-50" alt="Audit 2" />
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div className="aspect-square bg-white/5 rounded-xl border border-white/10 overflow-hidden">
                      <img src="https://images.unsplash.com/photo-1423592707957-3b212afa6733?auto=format&fit=crop&q=80" className="w-full h-full object-cover grayscale opacity-50" alt="Audit 3" />
                    </div>
                    <div className="aspect-[4/5] bg-white/5 rounded-xl border border-white/10 overflow-hidden">
                      <img src="https://images.unsplash.com/photo-1505664194779-8beaceb93744?auto=format&fit=crop&q=80" className="w-full h-full object-cover grayscale opacity-50" alt="Audit 4" />
                    </div>
                  </div>
                </div>
              ...
              <div className={`order-1 lg:order-2 transition-all duration-1000 transform ${visibleSections.methodology ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-[30vw]'}`}>
                <h2 className="text-4xl md:text-5xl font-serif font-bold text-white mb-10 leading-tight">
                  Our Regulatory <br />
                  <span className="italic font-light text-[#A07A41]">Audit Standard.</span>
                </h2>
                <div className="space-y-10">
                  {[
                    { step: '01', title: 'Frame Identification', text: 'Defining the specific regulatory framework (SRA, DPA, AML) relevant to the files being audited.' },
                    { step: '02', title: 'Systematic Triaging', text: 'Conducting a deep-scan of case documentation to identify compliance gaps or procedural errors.' },
                    { step: '03', title: 'Remediation Review', text: 'Preparing corrective drafting or documentation to bridge identified gaps in compliance.' },
                    { step: '04', title: 'Verification & Report', text: 'Issuing the final audit certificate and report confirming the file meets instructions and standards.' }
                  ].map((item, idx) => (
        ...
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`text-center mb-16 transition-all duration-1000 transform ${visibleSections.faqs ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
              ...
              <p className="text-gray-400 font-light">Addressing the complexities of legal compliance and auditing processes.</p>
            </div>
          ...
          <div className={`max-w-6xl mx-auto bg-[#1B2D33] rounded-3xl p-12 lg:p-20 border border-[#A07A41]/20 relative overflow-hidden text-center transition-all duration-1000 transform ${visibleSections.cta ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-20 scale-95'}`}>
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-serif font-bold text-white mb-8">
                ...
                <span className="italic font-light text-[#A07A41]">Reputation Secured.</span>
              </h2>
              <p className="text-gray-400 text-lg md:text-xl font-light mb-12 max-w-2xl mx-auto">
                Don't leave your regulatory standing to chance. Get meticulous audit support that satisfies every judicial standard.
              </p>
